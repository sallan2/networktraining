...
qgraph was developed in the context of psychometrics approach by Dr.~Sacha Epskamp and colleagues in 2012. We will be be working with \texttt{qgraph}. Please \texttt{install.packages("qgraph")} so we can get started.
